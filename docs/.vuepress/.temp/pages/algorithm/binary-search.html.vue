<template><div><h2 id="二分查找" tabindex="-1"><a class="header-anchor" href="#二分查找" aria-hidden="true">#</a> 二分查找</h2>
<h3 id="_35-搜索插入位置" tabindex="-1"><a class="header-anchor" href="#_35-搜索插入位置" aria-hidden="true">#</a> <a href="https://leetcode.cn/problems/search-insert-position/" target="_blank" rel="noopener noreferrer">35. 搜索插入位置<ExternalLinkIcon/></a></h3>
...
输出: 4
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 二分查找插入位置</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_74-搜索二维矩阵" tabindex="-1"><a class="header-anchor" href="#_74-搜索二维矩阵" aria-hidden="true">#</a> <a href="https://leetcode.cn/problems/search-a-2d-matrix/" target="_blank" rel="noopener noreferrer">74. 搜索二维矩阵<ExternalLinkIcon/></a></h3>
<p><strong>中等</strong></p>
<p>给你一个满足下述两条属性的 <code v-pre>m x n</code> 整数矩阵：</p>
<ul>
<li>每行中的整数从左到右按非严格递增顺序排列。</li>
<li>每行的第一个整数大于前一行的最后一个整数。</li>
</ul>
<p>给你一个整数 <code v-pre>target</code> ，如果 <code v-pre>target</code> 在矩阵中，返回 <code v-pre>true</code> ；否则，返回 <code v-pre>false</code> 。</p>
<p><strong>示例 1：</strong></p>
<p><img src="https://assets.leetcode.com/uploads/2020/10/05/mat.jpg" alt="img"></p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>输入：matrix = [[1,3,5,7],[10,11,16,20],[23,30,34,60]], target = 3
输出：true
...
<p><strong>示例 1：</strong></p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>输入：nums = [5,7,7,8,8,10], target = 8
输出：[3,4]
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_34-在排序数组中查找元素的第一个和最后一个位置-1" tabindex="-1"><a class="header-anchor" href="#_34-在排序数组中查找元素的第一个和最后一个位置-1" aria-hidden="true">#</a> <a href="https://leetcode.cn/problems/find-first-and-last-position-of-element-in-sorted-array/" target="_blank" rel="noopener noreferrer">34. 在排序数组中查找元素的第一个和最后一个位置<ExternalLinkIcon/></a></h3>
<p><strong>中等</strong></p>
<p>给你一个按照非递减顺序排列的整数数组 <code v-pre>nums</code>，和一个目标值 <code v-pre>target</code>。请你找出给定目标值在数组中的开始位置和结束位置。</p>
<p>如果数组中不存在目标值 <code v-pre>target</code>，返回 <code v-pre>[-1, -1]</code>。</p>
<p>你必须设计并实现时间复杂度为 <code v-pre>O(log n)</code> 的算法解决此问题。</p>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>输入：nums = [5,7,7,8,8,10], target = 6
输出：[-1,-1]
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>示例 3：</strong></p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>输入：nums = [], target = 0
输出：[-1,-1]
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_33-搜索旋转排序数组" tabindex="-1"><a class="header-anchor" href="#_33-搜索旋转排序数组" aria-hidden="true">#</a> <a href="https://leetcode.cn/problems/search-in-rotated-sorted-array/" target="_blank" rel="noopener noreferrer">33. 搜索旋转排序数组<ExternalLinkIcon/></a></h3>
<p><strong>中等</strong></p>
...
<ol>
<li>初始化左右指针，分别指向数组的开头和结尾。</li>
<li>循环，直到左右指针相遇或交叉：
<ul>
<li>计算中间索引。</li>
<li>如果中间元素等于目标值，则返回中间索引。</li>
<li>如果中间元素小于目标值，则目标值一定在中间索引的右边，更新左指针为中间索引加 1。</li>
<li>如果中间元素大于目标值，则目标值一定在中间索引的左边，更新右指针为中间索引减 1。</li>
</ul>
</li>
<li>如果循环结束，说明目标值不存在，返回 -1。</li>
</ol>
<p>**时间复杂度：**O(log n)，其中 n 是数组的长度。这是因为每次循环都会将搜索范围缩小一半。</p>
<p>**空间复杂度：**O(1)，因为算法不需要额外的空间。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token doc-comment comment">/**
 * 二分查找算法
 *
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_153-寻找旋转排序数组中的最小值" tabindex="-1"><a class="header-anchor" href="#_153-寻找旋转排序数组中的最小值" aria-hidden="true">#</a> <a href="https://leetcode.cn/problems/find-minimum-in-rotated-sorted-array/" target="_blank" rel="noopener noreferrer">153. 寻找旋转排序数组中的最小值<ExternalLinkIcon/></a></h3>
<p><strong>中等</strong></p>
<p>已知一个长度为 <code v-pre>n</code> 的数组，预先按照升序排列，经由 <code v-pre>1</code> 到 <code v-pre>n</code> 次 <strong>旋转</strong> 后，得到输入数组。例如，原数组 <code v-pre>nums = [0,1,2,4,5,6,7]</code> 在变化后可能得到：</p>
<ul>
<li>若旋转 <code v-pre>4</code> 次，则可以得到 <code v-pre>[4,5,6,7,0,1,2]</code></li>
<li>若旋转 <code v-pre>7</code> 次，则可以得到 <code v-pre>[0,1,2,4,5,6,7]</code></li>
</ul>
<p>注意，数组 <code v-pre>[a[0], a[1], a[2], ..., a[n-1]]</code> <strong>旋转一次</strong> 的结果为数组 <code v-pre>[a[n-1], a[0], a[1], a[2], ..., a[n-2]]</code> 。</p>
<p>给你一个元素值 <strong>互不相同</strong> 的数组 <code v-pre>nums</code> ，它原来是一个升序排列的数组，并按上述情形进行了多次旋转。请你找出并返回数组中的 <strong>最小元素</strong> 。</p>
<p>你必须设计一个时间复杂度为 <code v-pre>O(log n)</code> 的算法解决此问题。</p>
<p><strong>示例 1：</strong></p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>输入：nums = [3,4,5,1,2]
输出：1
...
<p>给定一个旋转排序数组，即一个有序数组经过多次旋转后形成的数组，寻找其中的最小值。</p>
<p>我们可以使用二分查找算法来解决这个问题。二分查找算法的基本思想是：</p>
<ol>
<li>将数组分成两半。</li>
<li>如果目标值在前半部分，则将后半部分舍弃。</li>
<li>如果目标值在后半部分，则将前半部分舍弃。</li>
<li>重复步骤 1-3，直到找到目标值或数组为空。</li>
</ol>
<p><strong>本题的特殊情况：</strong></p>
<p>旋转排序数组与普通有序数组不同，它可能存在多个递增子序列。因此，我们不能直接使用二分查找算法。</p>
<p><strong>解决办法：</strong></p>
<p>我们可以利用旋转排序数组的性质：</p>
<ul>
<li>旋转排序数组一定包含一个递增子序列。</li>
<li>最小值一定在这个递增子序列中。</li>
</ul>
<p>因此，我们可以使用二分查找算法来寻找这个递增子序列。具体步骤如下：</p>
<ol>
<li>定义左右边界 <code v-pre>l</code> 和 <code v-pre>r</code>，分别为 0 和 <code v-pre>nums.length - 1</code>。</li>
<li>计算中点 <code v-pre>mid</code>。</li>
<li>如果 <code v-pre>nums[mid] &lt; nums[r]</code>，说明最小值在中点左边，因此将 <code v-pre>r</code> 更新为 <code v-pre>mid</code>。</li>
<li>否则，说明最小值在中点右边，因此将 <code v-pre>l</code> 更新为 <code v-pre>mid + 1</code>。</li>
<li>重复步骤 2-4，直到 <code v-pre>l</code> 和 <code v-pre>r</code> 相等。</li>
<li>返回 <code v-pre>nums[l]</code>，即最小值。</li>
</ol>
<p>**时间复杂度：**O(log n)，其中 n 为数组长度。</p>
<p>**空间复杂度：**O(1)。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token doc-comment comment">/**
 * 寻找旋转排序数组中的最小值
 * <span class="token keyword">@param</span> <span class="token class-name"><span class="token punctuation">{</span>number<span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token punctuation">}</span></span> <span class="token parameter">nums</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-寻找两个正序数组的中位数" tabindex="-1"><a class="header-anchor" href="#_4-寻找两个正序数组的中位数" aria-hidden="true">#</a> <a href="https://leetcode.cn/problems/median-of-two-sorted-arrays/" target="_blank" rel="noopener noreferrer">4. 寻找两个正序数组的中位数<ExternalLinkIcon/></a></h3>
...
<p><strong>示例 1：</strong></p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>输入：nums1 = [1,3], nums2 = [2]
输出：2.00000
解释：合并数组 = [1,2,3] ，中位数 2
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>输入：nums1 = [1,2], nums2 = [3,4]
输出：2.50000
解释：合并数组 = [1,2,3,4] ，中位数 (2 + 3) / 2 = 2.5
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>解题思路</li>
</ul>
<p>这段代码的解题思路是用于找到两个已排序数组的中位数。下面是详细的解题思路：</p>
<ol>
<li>
<p>首先，将两个输入的已排序数组 <code v-pre>nums1</code> 和 <code v-pre>nums2</code> 合并成一个新数组 <code v-pre>arr</code>，这样可以将两个数组中的元素整合到一个数组中，方便后续处理。</p>
</li>
<li>
<p>接着，对新数组 <code v-pre>arr</code> 进行排序，以确保数组中的元素按照升序排列，这样可以更方便地找到中位数。</p>
</li>
<li>
<p>然后，判断新数组 <code v-pre>arr</code> 的长度是否为奇数。如果是奇数，直接返回中间位置的元素作为中位数；如果是偶数，取中间两个元素的平均值作为中位数。</p>
</li>
<li>
<p>最后，根据判断条件返回对应的中位数值。</p>
</li>
</ol>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 定义一个函数 findMedianSortedArrays，接受两个参数 nums1 和 nums2</span>
