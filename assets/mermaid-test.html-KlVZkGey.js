import{_ as n,o as s,c as e,d as i}from"./app-CaGugdex.js";const r={};function t(l,a){return s(),e("div",null,[...a[0]||(a[0]=[i(`<h1 id="mermaid-图表示例" tabindex="-1"><a class="header-anchor" href="#mermaid-图表示例" aria-hidden="true">#</a> Mermaid 图表示例</h1><h2 id="流程图-flowchart" tabindex="-1"><a class="header-anchor" href="#流程图-flowchart" aria-hidden="true">#</a> 流程图 (Flowchart)</h2><div class="language-mermaid line-numbers-mode" data-ext="mermaid"><pre class="language-mermaid"><code><span class="token keyword">flowchart</span> TD
