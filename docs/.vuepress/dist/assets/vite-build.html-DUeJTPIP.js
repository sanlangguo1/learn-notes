import{_ as e,r as p,o as t,c as l,d as i,a as s,b as o,e as c}from"./app-BTM0SXbh.js";const r="/learn-notes/img/vite-build.jpg",u={},d={href:"https://github.com/sanyuan0704/vite-plugin-chunk-split/blob/HEAD/README-CN.md#vite-plugin-chunk-split",target:"_blank",rel:"noopener noreferrer"};function v(k,n){const a=p("ExternalLinkIcon");return t(),l("div",null,[n[1]||(n[1]=i(`<h2 id="记录-vite4-x-vue3-打包优化" tabindex="-1"><a class="header-anchor" href="#记录-vite4-x-vue3-打包优化" aria-hidden="true">#</a> 记录 vite4.x vue3 打包优化</h2><h3 id="打包之前我们先梳理下vite-打包从哪些方面入手" tabindex="-1"><a class="header-anchor" href="#打包之前我们先梳理下vite-打包从哪些方面入手" aria-hidden="true">#</a> 打包之前我们先梳理下vite 打包从哪些方面入手</h3><ol><li>先对打包体积进行分析</li><li>根据包体积分析的结果，做相应的优化，之后我们以下几个方面入手：</li></ol><ul><li>图片压缩</li><li>gzip代码压缩</li><li>删除生产日志</li><li>CDN 加速</li><li>按需导入</li></ul><h3 id="包分析" tabindex="-1"><a class="header-anchor" href="#包分析" aria-hidden="true">#</a> 包分析</h3><ul><li>安装与使用</li></ul><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token number">1.</span>安装 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>包分析 <img src="`+r+`" alt="vite打包分析"></li></ul><h3 id="gzip代码压缩" tabindex="-1"><a class="header-anchor" href="#gzip代码压缩" aria-hidden="true">#</a> gzip代码压缩</h3><ul><li>安装与使用</li></ul><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token number">1.</span>安装 
...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,32)),s("p",null,[s("a",d,[n[0]||(n[0]=o("更多配置参考github",-1)),c(a)])])])}const b=e(u,[["render",v],["__file","vite-build.html.vue"]]);export{b as default};
