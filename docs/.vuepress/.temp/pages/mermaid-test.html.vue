<template><div><h1 id="mermaid-图表示例" tabindex="-1"><a class="header-anchor" href="#mermaid-图表示例" aria-hidden="true">#</a> Mermaid 图表示例</h1>
<h2 id="流程图-flowchart" tabindex="-1"><a class="header-anchor" href="#流程图-flowchart" aria-hidden="true">#</a> 流程图 (Flowchart)</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="序列图-sequence-diagram" tabindex="-1"><a class="header-anchor" href="#序列图-sequence-diagram" aria-hidden="true">#</a> 序列图 (Sequence Diagram)</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="类图-class-diagram" tabindex="-1"><a class="header-anchor" href="#类图-class-diagram" aria-hidden="true">#</a> 类图 (Class Diagram)</h2>
<div class="language-mermaid line-numbers-mode" data-ext="mermaid"><pre v-pre class="language-mermaid"><code><span class="token keyword">classDiagram</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="状态图-state-diagram" tabindex="-1"><a class="header-anchor" href="#状态图-state-diagram" aria-hidden="true">#</a> 状态图 (State Diagram)</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="甘特图-gantt-chart" tabindex="-1"><a class="header-anchor" href="#甘特图-gantt-chart" aria-hidden="true">#</a> 甘特图 (Gantt Chart)</h2>
<div class="language-mermaid line-numbers-mode" data-ext="mermaid"><pre v-pre class="language-mermaid"><code><span class="token keyword">gantt</span>
    title 项目计划
